...
public class CharacterSelectorUI : MonoBehaviour
{
    ...
    {
        HelperUltilities.ValidateCheckNullValue(this, nameof(characterSelector), characterSelector);
        HelperUltilities.ValidateCheckNullValue(this, nameof(playerNameInput), playerNameInput);
    }
#endif
    #endregion
}
