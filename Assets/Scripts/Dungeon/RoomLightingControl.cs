...
public class RoomLightingControl : MonoBehaviour
{
    ...
    private IEnumerator FadeInRoomLightingRoutine(InstantiatedRoom instantiated)
    {
    ...
    private void FadeInDoors()
    {
        ...
        {
            DoorLightingControl doorLightingContrtol = door.GetComponentInChildren<DoorLightingControl>();

            doorLightingContrtol.FadeInDoor(door);
        }
    }
}
