...
public class ReloadWeapon : MonoBehaviour
{
    ...
    {
        reloadWeaponEvent.OnReloadWeapon += ReloadWeaponEvent_OnRealoadWeapon;
    ...
    private void ReloadWeaponEvent_OnRealoadWeapon(ReloadWeaponEvent reloadWeaponEvent, ReloadWeaponEventArgs reloadWeaponEventArgs)
    {
